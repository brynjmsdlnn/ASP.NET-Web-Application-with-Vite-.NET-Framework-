...
A lightweight Visual Studio starter template for **ASP.NET Framework 4.8.1 MVC/Web API** projects, with **Vite 8** for modern JavaScript/CSS bundling and **Bootstrap 5.2.3** integration.
